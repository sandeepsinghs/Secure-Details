...
public class MyFont {
    ...
    public static final String SEMI_BOLD = "OpenSans-SemiBold.ttf";
    public static final String FONT_LIGHT = "OpenSans-Light.ttf";
    public static final String HINDI_FONT_RAGULARE = "NotoSansDevanagari-Regular.ttf";
    public static final String HINDI_FONT_BOLD = "NotoSansDevanagari-Bold.ttf";


    public static final String DEFAULT_FONT = FONT_REGULAR;
    ...
    public static final String MY_FONT = FONT_REGULAR;
    public static final int MY_STYLE = NORMAL;

    private String[] fontList =
            {
                    FONT_REGULAR, FONT_BOLD, SEMI_BOLD, FONT_LIGHT
            };
